<html>
   ...
   *{
   ...
   <br>
	...
	<h3><p align="center" > Borderlands 3 <p> </h3> <Br><br><br>
	
       <hr>
       <br>
       <br>

       <img src="boderlands.jpg" width="250" height="300" class="img2"> <br>  <p class="categoria">O jogo de tiro original está de volta, com milhões de armas novas e uma aventura<br> cheia de destruição! Acabe com novos mundos e inimigos para salvar o seu lar dos,<br> líderes cultistas mais cruéis da galáxia.</p>
       <br>
	   <p class="compra">R$ 122,99 </p> <br>
